...
c.memLire=()=>({chroma:true,chromaSource:6,swing:.6,motifs:[{notes:[[2],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null]}]});
...
console.log('PO-33 v229 : 16 effets live, SWING, CHROMA, Parameter Locks et migrations OK.');
