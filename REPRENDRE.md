...
La version actuelle est la **252**. Depuis la v176, le détail de chaque version est dans
...
- *Bibliothèque* : Freesound (v248), sons de chaque machine et kits de sons avec retour arrière (v251), classement des sons (v252).
