...
- *Eurorack, au-delà du cœur du système* : huit ensembles complets (v276), installateur Windows automatique et
  ...
  après CYCLES LIBRES (v293), VOIX MUTANTES (v294), POLY 4 (v295), LOOPER DE RACK (v296).
...
2. *Eurorack, suite proposée après la v296* : DIALOGUE (deux mélodies qui se répondent) ; ACCORDAGES ET
   ORNEMENTS (accordage par note, import Scala .scl).
