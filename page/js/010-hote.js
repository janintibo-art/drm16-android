  ...
  function installerAutotest(h, natif){
    ...
    function lancer(){
      ...
      function essaiMidi(){
        ...
        h.midiOuvrirId(id);
        return attendreQue(function(){ return MIDI.ouvertId === id; }, 4000).then(function(ouvert){
          t(ouvert, "MIDI : « " + c[0] + " » ouvert, confirmé par __midiEtat");
          if(!ouvert) return;
          var sansErreur = true;
          try{
          ...
          }).then(function(ferme){ t(ferme, "MIDI : horloge lancée puis arrêtée, appareil fermé"); });
        });
      }
